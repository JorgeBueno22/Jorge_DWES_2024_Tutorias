...
insert into actividad (obligatoria,nombre,descripcion) values (true,'natacion','interesante');
insert into actividad (obligatoria,nombre,descripcion) values (true,'ajedrez','divertida');
insert into actividad (obligatoria,nombre,descripcion) values (false,'tenis','dinamica');
insert into actividad (obligatoria,nombre,descripcion) values (true,'teatro','creativa');
